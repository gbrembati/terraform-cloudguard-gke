...
This Terraform project is intended to be used to create a Kubernetes environment in GCP and onboards it in the CloudGuard Native Portal.     
...
7. **Create the Check Point components**: it creates all the components needed in the cluster using an Helm Chart
